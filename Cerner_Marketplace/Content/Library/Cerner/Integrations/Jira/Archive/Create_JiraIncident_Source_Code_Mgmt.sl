...
flow:
  name: Create_JiraIncident_Source_Code_Mgmt
  inputs:
    - projectId: '40703'
    - issueTypeId: '46'
    - reporter
    ...
    - Depot:
        default: ' '
        required: false
    - StreamNameFileLocation:
        default: ' '
        required: false
    - IsThisImpactingOtherUsers:
        default: ' '
        required: false
    - WhatIsTheErrorMessage:
        default: ' '
        required: false
    - WorkflowToReproduceIssue: ' '
  workflow:
    ...
    - set_httpClient_Body:
        do:
          io.cloudslang.base.utils.do_nothing:
            - httpClient_Body: "${'{    \"fields\": {         \"project\": { \"id\": \"'+projectId+'\" }, \"summary\": \"'+summary+'\", \"issuetype\": { \"id\": \"'+issueTypeId+'\"}, \"reporter\": { \"name\": \"'+reporter[0:reporter.find(\"@\")]+'\"}, \"priority\": { \"id\": \"'+jiraPriorityId+'\" }, \"customfield_47251\": \"'+criticalityJustification.strip()+'\",\"description\":'+description+', \"'+jiraToolFieldId+'\":{ \"id\": \"'+jiraTool+'\" }, \"'+watcherFieldId+'\": ['+watchersJSON+'],\"customfield_46822\":\"'+WorkflowToReproduceIssue+'\",\"customfield_46826\":\"'+WhatIsTheErrorMessage+'\",\"customfield_46827\": { \"id\": \"'+IsThisImpactingOtherUsers+'\" },\"customfield_46823\":\"'+StreamNameFileLocation+'\",\"customfield_46824\":\"'+Depot+'\",\"customfield_47209\": { \"id\": \"'+GitHubInstance+'\" },\"customfield_46835\":\"'+SVNRepoURL+'\",\"'+jiraSmaxIdFieldId+'\": \"'+smaxRequestID+'\" } }'}"
        publish:
          - httpClient_Body
        navigate:
