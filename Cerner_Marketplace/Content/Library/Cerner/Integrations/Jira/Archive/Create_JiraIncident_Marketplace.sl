...
flow:
  name: Create_JiraIncident_Marketplace
  inputs:
    - projectId: '40703'
    - issueTypeId: '46'
    - reporter
  ...
  workflow:
    ...
    - set_httpClient_Body:
        do:
          io.cloudslang.base.utils.do_nothing:
            - httpClient_Body: "${'{    \"fields\": {         \"project\": { \"id\": \"'+projectId+'\" }, \"summary\": \"'+summary+'\", \"issuetype\": { \"id\": \"'+issueTypeId+'\"}, \"reporter\": { \"name\": \"'+reporter[0:reporter.find(\"@\")]+'\"},\"priority\": { \"id\": \"'+jiraPriorityId+'\" }, \"customfield_47251\": \"'+criticalityJustification.strip()+'\",\"description\":'+description+', \"'+jiraToolFieldId+'\":{ \"id\": \"'+jiraTool+'\" }, \"'+watcherFieldId+'\": ['+watchersJSON+'],\"'+jiraSmaxIdFieldId+'\": \"'+smaxRequestID+'\",\"'+jiraMarketplaceIssueTypeID+'\": { \"id\": \"'+MarketplaceIssueTypeID+'\"},\"'+jiraMarketplaceStorefrontID+'\": { \"id\": \"'+MarketplaceStorefrontID+'\"},\"'+jiraMarketOfferNameID+'\": \"'+MarketOfferName+'\" } }'}"
        publish:
          - httpClient_Body
        navigate:
    ...
    - getSMAXSystemProperty_SmaxRequestFieldID:
        ...
        publish:
          - result
          - message
          - jiraSmaxIdFieldId: '${SystemPropValue}'
          - errorType
          - errorMessage: '${message}'
        navigate:
          - SUCCESS: getSMAXSystemProperty_jiraMarketplaceIssueTypeID
          - FAILURE: MainErrorHandler
    - MainErrorHandler:
        do:
    ...
    - set_message_JIRA:
        ...
        navigate:
          - SUCCESS: MainErrorHandler
          - FAILURE: on_failure
    - Get_MarketplaceIssueType:
        do:
          io.cloudslang.base.json.get_value:
            - json_input: "${get_sp('MarketPlace.MarketIssueType')}"
            - json_path: '${MarketplaceIssueType}'
        publish:
          - MarketplaceIssueTypeID: '${return_result}'
          - errorMessage: '${error_message}'
        navigate:
          - SUCCESS: Get_MarketStorefront
          - FAILURE: set_message
    - set_message:
        do:
          io.cloudslang.base.utils.do_nothing:
        ...
        navigate:
          - SUCCESS: MainErrorHandler
          - FAILURE: on_failure
    - Get_MarketStorefront:
        do:
          io.cloudslang.base.json.get_value:
            - json_input: "${get_sp('MarketPlace.MarketStorefront')}"
            - json_path: '${MarketStorefront}'
        publish:
          - MarketplaceStorefrontID: '${return_result}'
          - errorMessage: '${error_message}'
        navigate:
    ...
    - get_priorityId:
        ...
        publish:
          ...
          - errorMessage: '${error_message}'
        navigate:
          - SUCCESS: Get_MarketplaceIssueType
    ...
    - set_message_2:
        ...
        navigate:
          - SUCCESS: MainErrorHandler
          - FAILURE: on_failure
    - getSMAXSystemProperty_jiraMarketplaceIssueTypeID:
        do:
          Cerner.DigitalFactory.Common.SMAX.Operation.getSMAXSystemProperty:
            - propertyKey: jiraMarketplaceIssueTypeID
        publish:
          - result
          - message
          - jiraMarketplaceIssueTypeID: '${SystemPropValue}'
          - errorType
          - errorMessage: '${message}'
        navigate:
          - SUCCESS: getSMAXSystemProperty_MarketplaceStorefrontID
          - FAILURE: on_failure
    - getSMAXSystemProperty_MarketplaceStorefrontID:
        do:
          Cerner.DigitalFactory.Common.SMAX.Operation.getSMAXSystemProperty:
            - propertyKey: jiraMarketplaceStorefrontID
        publish:
          - result
          - message
          - jiraMarketplaceStorefrontID: '${SystemPropValue}'
          - errorType
          - errorMessage: '${message}'
        navigate:
          - SUCCESS: getSMAXSystemProperty_MarketOfferName
          - FAILURE: on_failure
    - getSMAXSystemProperty_MarketOfferName:
        do:
          Cerner.DigitalFactory.Common.SMAX.Operation.getSMAXSystemProperty:
            - propertyKey: jiraMarketOfferNameID
        publish:
          - result
          - message
          - jiraMarketOfferNameID: '${SystemPropValue}'
          - errorType
          - errorMessage: '${message}'
        navigate:
