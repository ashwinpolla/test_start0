...
flow:
  ...
  workflow:
    ...
    - Set_Status_Message:
        do:
          io.cloudslang.base.utils.do_nothing:
            - status_message: 'Add  Server Action Started...!!!!'
        publish:
          - status_message
        navigate:
    ...
    - Set_Status_Message_1:
        do:
          io.cloudslang.base.utils.do_nothing:
            - status_message: 'Add Server  Action COMLETED...!!!!'
        publish:
          - status_message
        navigate:
    ...
    - Set_Status_Message_2:
        do:
          io.cloudslang.base.utils.do_nothing:
            - status_message: 'Add Server Action FAILED ....!!!'
        publish:
          - status_message
        navigate:
